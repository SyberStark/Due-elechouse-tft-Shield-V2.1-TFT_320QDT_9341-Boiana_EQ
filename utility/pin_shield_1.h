...
//####################################### DUE ############################
  ...
  #include <sam3xa.h>
  #define D0_PORT PIOA
  #define D0_PIN  8//34 //8
  #define D1_PORT PIOA
  #define D1_PIN  9//35 //9
  #define D2_PORT PIOB
  #define D2_PIN  25//36 //25
  #define D3_PORT PIOC
  #define D3_PIN  28//37 //28
  #define D4_PORT PIOC   //also PA29
  #define D4_PIN  26//38 //26
  #define D5_PORT PIOC
  #define D5_PIN  25//39 //25
  #define D6_PORT PIOC
  #define D6_PIN  24//40 //24
  #define D7_PORT PIOC
  #define D7_PIN  23//41 //23
  #define D8_PORT PIOC
  #define D8_PIN  22//51 //22
  #define D9_PORT PIOC
  #define D9_PIN  21//50 //21
  #define D10_PORT PIOC  //also PA28
  #define D10_PIN 29//49 //29
  #define D11_PORT PIOD
  #define D11_PIN 7//48 //7
  #define D12_PORT PIOD
  #define D12_PIN 8//47 //8
  #define D13_PORT PIOB
  #define D13_PIN 27//46 //27
